...
export default function Aboutus(props) {
  return (
        <div className='container'>
            <h1 className={`text-${props.mode==='dark'?'white':'#042743'}`}>About Us</h1>
            <div className="accordion" id="accordionExample" >
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" style={{ backgroundColor: props.mode ==='dark'?'#042743':'white', color: props.mode ==='dark'?'white':'#042743'}} className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
